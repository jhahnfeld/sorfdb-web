...
import type { SorfdbClusterApi as SorfdbApi } from "@/SorfdbApi";
...
import { defaultClusterColumns } from "./ResultColumns";
import ResultTable from "./ClusterResultTable.vue";
...
const props = defineProps({
  ...
  entries: { type: Array as PropType<ClusterSearchEntry[]>, required: true },
...
const selectedColumns = ref<string[]>(defaultClusterColumns());
...
function resetSelection() {
  selectedColumns.value = defaultClusterColumns();
}
